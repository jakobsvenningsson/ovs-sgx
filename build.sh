...
make -C hotcall_bundler/src/trusted SGX_MODE=HW SGX_PRERELEASE=1 SGX_DEBUG=0 LFLAGS="$FLAGS"

echo "%%%%%%%%%%%%%%%%%%%%%%%%% BUILDING HOTCALL BUNDLER UNTRUSTED"
make -C hotcall_bundler/src/untrusted clean
make -C hotcall_bundler/src/untrusted SGX_MODE=HW SGX_PRERELEASE=1 SGX_DEBUG=0 LFLAGS="$FLAGS"
...
./configure	CFLAGS="$FLAGS -I${ROOT_FOLDER}/TLSonSGX/untrusted \
                           ...
                           -I${ROOT_FOLDER}/hotcall_bundler/src/lib \
            	...
            	LIBS="  -lOFTonSGX -lhotcall_bundler_untrusted -lpthread -lstdc++ "
