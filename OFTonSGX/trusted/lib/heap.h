...
#ifndef ENCLAVE_HEAP_H
#define ENCLAVE_HEAP_H 1
...
void heap_swap_ovs(struct heap *a, struct heap *b);
static inline size_t heap_count_ovs(const struct heap *);
static inline bool heap_is_empty_ovs(const struct heap *);

/* Insertion and deletion. */
void heap_insert_ovs(struct heap *, struct heap_node *, uint32_t priority);
void heap_change_ovs(struct heap *, struct heap_node *, uint32_t priority);
void heap_remove_ovs(struct heap *, struct heap_node *);
static inline struct heap_node *heap_pop_ovs(struct heap *);

/* Maximum.  */
static inline struct heap_node *heap_max_ovs(const struct heap *);
...
void heap_raw_insert_ovs(struct heap *, struct heap_node *, uint32_t priority);
static inline void heap_raw_change_ovs(struct heap_node *, uint32_t priority);
...
static inline size_t
heap_count_ovs(const struct heap *heap)
{
    return heap->n;
}
 ...
 * element. */
static inline bool
heap_is_empty_ovs(const struct heap *heap)
{
    return heap->n == 0;
}
...
heap_max_ovs(const struct heap *heap)
{
    return heap->array[1];
}
 ...
 * This takes time O(1). */
static inline void
heap_raw_change_ovs(struct heap_node *node, uint32_t priority)
{
